...
[![](http://upload-images.jianshu.io/upload_images/2178672-51a2fe6fbe24d1cd.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)](http://micropieces.github.io/)

在手机上的布局：

[![](http://upload-images.jianshu.io/upload_images/2178672-d58bb45f9faedb70.jpg)](http://micropieces.github.io/)
...
注册完成后搜索 `micropieces.github.io` 进入[我的仓库](https://github.com/MicroPieces/micropieces.github.io)
...
这时你在在浏览器中输入 `你的Github账号名.github.io` 例如:`http://micropieces.github.io`
...
keyword: "BY, BY Blog, 傅枫的博客, qiubaiying, 傅枫, iOS, Apple, iPhone" #关键词
url: "https://micropieces.github.io"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
一个主机记录为 `www`,代表可以解析 `www.micropieces.top`的域名

另一个为 `@`, 代表 `micropieces.top`
...
若本教程顺利帮你搭建了自己的个人博客，请不要 **害羞**，给我的 [github仓库](https://github.com/MicroPieces/micropieces.github.io) 点个 **star** 吧！

因为最近发现 Fork 将近破百，加上直接 Clone 仓库的，保守估计已经帮助上百人成功的搭建了自己的博客，~~可是 Star 却仅仅只有 **12**！可能还是做的不够好吧！~~现在已经破百了，感谢大家的Star！

### **别无他求，点个 [Star](https://github.com/MicroPieces/micropieces.github.io) 吧**！
